...
echo 'Compiling out/lz4png_adapter.o'
$CXX -c -march=native \
    $CXXFLAGS adapter/lz4png_adapter.cpp \
    $LDFLAGS -o out/lz4png_adapter.o
...
$CC -DCONFIG_FULL_BENCHMARKS=1 \
    ...
    out/zpng_adapter.o \
    -L../libjxl/build \
    $LDFLAGS -ljxl -llz4 -lpng -lstdc++ -lwebp -lzstd -o out/full_benchmarks
